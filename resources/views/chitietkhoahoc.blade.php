    ...
    <div class="col-xs-12">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Thông tin chung về khóa học ABC</h3>

        </div>
        <!-- /.box-header -->
                <div class="box-body">
          <div class="row">
            <div class="col-md-3 ">Tên khóa học:</div><div class="col-md-9">{{$chitiet->ten}}</div>
            <div class="col-md-3 ">Ngôn ngữ:</div><div class="col-md-9">{{$chitiet->ngonngu}}</div>
            <div class="col-md-3 ">Thời gian bắt đầu:</div><div class="col-md-9">{{$chitiet->thoigianbatdau}}</div>
            <div class="col-md-3 ">Thời gian kết thúc:</div><div class="col-md-9">{{$chitiet->thoigianketthuc}}</div>
            <div class="col-md-3 ">Số lớp: </div><div class="col-md-9">2</div>
          </div>
        </div>
      </div>
